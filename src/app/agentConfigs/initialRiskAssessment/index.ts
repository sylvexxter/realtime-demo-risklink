...
import anit_virus_Agent from "./anti_virus";
...
system_security_Agent.downstreamAgents = [anit_virus_Agent]
anit_virus_Agent.downstreamAgents = [access_control_Agent]
...
const agents = injectTransferTools([greeting_Agent, training_awareness_Agent, asset_management_Agent, data_protection_privacy_Agent, backups_Agent, system_security_Agent, anit_virus_Agent, access_control_Agent, incident_response_Agent]);
